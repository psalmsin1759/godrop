        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 gap-3">
            <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: '#E7EEFF' }}>
              <Tag className="w-6 h-6" style={{ color: '#1E5FFF' }} />
            </div>
            <p className="text-xs text-[#9AA1B4]">No categories yet</p>
              ...
              <tbody className="divide-y divide-[#F7F9FC]">
                {categories.map((cat) => (
                  <tr key={cat.id} className="hover:bg-[#F7F9FC] transition-colors">
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2.5">
                        {cat.imageUrl ? (
                          ...
                          <div className="w-8 h-8 rounded flex items-center justify-center shrink-0" style={{ backgroundColor: '#E7EEFF' }}>
                            <Tag className="w-4 h-4" style={{ color: '#1E5FFF' }} />
                          </div>
                        )}
                        <p className="text-xs font-semibold text-[#0D1426]">{cat.name}</p>
                      </div>
                    </td>
                    <td className="px-4 py-3 max-w-[200px]">
                      <span className="text-xs text-[#525A72] truncate block" title={cat.description}>
                        {cat.description || '—'}
                      </span>
                    </td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3">
                      <span className="text-xs text-[#525A72]">{cat.sortOrder}</span>
                    </td>
                    <td className="px-4 py-3">
                      <button
