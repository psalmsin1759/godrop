    ...
    return (
      ...
      >
        ...
        <p className="text-white/60">
          This password reset link is missing or invalid. Request a new one from the Godrop app&apos;s
  ...
  if (success) {
    return (
      ...
      >
        ...
        <p className="text-white/60">
          Your password has been updated. You can now log in with your new password in the Godrop app.
        </p>
      </motion.div>
    );
  }
