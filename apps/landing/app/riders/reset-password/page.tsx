...
export const metadata: Metadata = {
  title: "Reset Rider Password — Godrop",
  description: "Choose a new password for your Godrop Rider account.",
};
    ...
    <PageShell>
      <section className="grain relative overflow-hidden bg-ink">
        ...
        <div className="relative mx-auto w-full max-w-xl px-6 py-24 sm:px-10">
          <div className="mb-16">
            <p className="mono-label mb-8 text-accent">Rider account security</p>
            ...
            <p className="mt-7 max-w-xl text-lg leading-relaxed text-white/60">
              Choose a strong new password for your Godrop Rider account.
            </p>
          </div>
