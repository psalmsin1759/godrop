...
class _FavoritesService implements FavoritesService {
  _FavoritesService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<FavoritesResponse> listFavorites() async {
  ...
  @override
  Future<MessageResponse> addFavorite(ToggleFavoriteBody body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<MessageResponse> removeFavorite(String vendorId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
