...
class _NotificationsService implements NotificationsService {
  ...
  @override
  Future<MessageResponse> registerPushToken(PushTokenBody body) async {
  ...
  @override
  Future<MessageResponse> removePushToken(RemovePushTokenBody body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<MessageResponse> markRead(MarkNotificationsReadBody body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
