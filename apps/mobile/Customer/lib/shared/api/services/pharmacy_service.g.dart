...
class _PharmacyService implements PharmacyService {
  _PharmacyService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<PharmacyListResponse> listPharmacies({
    ...
    final _options = _setStreamType<PharmacyListResponse>(
  ...
  @override
  Future<PharmacyDetailResponse> getPharmacy(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PharmacyDetailResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/pharmacy/stores/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PharmacyDetailResponse _value;
    try {
      _value = PharmacyDetailResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<PharmacySearchResponse> search({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PharmacySearchResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/pharmacy/search',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PharmacySearchResponse _value;
    try {
      _value = PharmacySearchResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
