...
class _RetailService implements RetailService {
  _RetailService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<RetailCategoriesResponse> listCategories() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RetailCategoriesResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/retail/categories',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RetailCategoriesResponse _value;
    try {
      _value = RetailCategoriesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
