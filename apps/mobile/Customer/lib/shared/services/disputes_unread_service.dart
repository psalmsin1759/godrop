...
/// Tracks how many of the customer's disputes have an admin reply or
/// resolution they haven't viewed yet. Drives the badge on the bottom-nav
/// Profile tab and the "My disputes" entry point.
class DisputesUnreadService {
  ...
  static Future<void> refresh() async {
    try {
      final response = await DioClient.instance.get('/disputes/unread-count');
