...
part of 'rider_auth_service.dart';
...
class _RiderAuthService implements RiderAuthService {
  _RiderAuthService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<dynamic> refresh(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<dynamic> passwordLogin(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
