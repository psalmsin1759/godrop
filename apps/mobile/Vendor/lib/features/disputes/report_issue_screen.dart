...
class _ReportIssueScreenState extends State<ReportIssueScreen> {
  ...
  final _uploadService = UploadService(DioClient.instance);
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      for (final path in _photoPaths) {
        evidenceUrls.add(await _uploadService.uploadDisputeEvidence(path));
      }
      ...
      body: ListView(
        ...
        children: [
          ...
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: vendorDisputeCategories.map((c) {
