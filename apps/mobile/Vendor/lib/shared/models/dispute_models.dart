...
/// Categories relevant to a vendor reporting a problem on an order —
/// excludes VENDOR_BEHAVIOR, which is for others to report against them.
const vendorDisputeCategories = [
  'CUSTOMER_BEHAVIOR',
  'RIDER_BEHAVIOR',
  'PAYMENT_ISSUE',
  'OTHER',
